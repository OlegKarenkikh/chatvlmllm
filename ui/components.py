...
def render_code_example(code: str, language: str = "python", caption: str = None) -> None:
    """
...
def render_image_preview(image, caption: str = "Preview", max_width: int = None) -> None:
    """
    ...
    """
    st.image(image, caption=caption, use_container_width=True if max_width is None else False)
